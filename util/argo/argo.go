...
func mergeVirtualProject(proj *argoappv1.AppProject, globalProj *argoappv1.AppProject) *argoappv1.AppProject {
	...
	proj.Spec.ClusterResourceAllowlist = append(proj.Spec.ClusterResourceAllowlist, globalProj.Spec.ClusterResourceAllowlist...)
	proj.Spec.ClusterResourceBlocklist = append(proj.Spec.ClusterResourceBlocklist, globalProj.Spec.ClusterResourceBlocklist...)

	proj.Spec.NamespaceResourceAllowlist = append(proj.Spec.NamespaceResourceAllowlist, globalProj.Spec.NamespaceResourceAllowlist...)
	proj.Spec.NamespaceResourceBlocklist = append(proj.Spec.NamespaceResourceBlocklist, globalProj.Spec.NamespaceResourceBlocklist...)
