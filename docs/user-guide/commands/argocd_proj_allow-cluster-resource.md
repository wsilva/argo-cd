...
Adds a cluster-scoped API resource to the allowlist and removes it from blocklist
...
```
  ...
  -l, --list string   Use blocklist or allowlist. This can only be 'allow' or 'block' (default "allow")
```
